...
impl Flair {
    pub fn new(id: usize, name: String, assigned_on: DateTime<Utc>, flair: usize) -> Self { Self { id, name, assigned_on, flair } }
}
...
impl FlairDirectory {
    pub fn new(id: Option<usize>, special: bool, ref_id: String, pos: usize, flair: usize, path: Option<String>) -> Self { Self { id, special, ref_id, pos, flair, path } }
}
